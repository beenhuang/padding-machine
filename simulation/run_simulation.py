...
''' 
<file>    simulate.py
<brief>   run simulation with padding machines
'''
...
def parse_arguments():
    ...
    parser.add_argument("-m", "--machine", required=True, metavar="<padding_machine>", help="load specified padding machines.")
...
def main():
    ...
    output_file = join(OUTPUT_DIR, args["out"]+"-"+max_length+".pkl")
