...
/**
 * REB the RELAY-side circuit padding machine on the general circuit.
 */  
...
/********************  [START OF STATES]  *********************/
  ...
  relay_machine->states[0].next_state[CIRCPAD_EVENT_NONPADDING_SENT] = 1;
...
/*****************************  [END OF STATES]  *****************************/
  ...
  /* [LOGGING] : */
  log_info(LD_CIRC, "[REB_RELAY] Registered the REB relay padding machine (%u)", relay_machine->machine_num);
