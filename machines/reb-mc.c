...
/**
 * REB CLIENT-side circuit padding machine on the general circuit.
 */  
  ...
  client_machine->name = "reb_client";
...
/*****************************  [END OF STATES]  *****************************/
  ...
  /* [LOGGING] : */
  log_info(LD_CIRC, "[REB_CLIENT] Registered the REB client padding machine (%u)", client_machine->machine_num);
